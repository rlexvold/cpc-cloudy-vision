...
def call_vision_api(image_filename, api_keys):
    ...
    post_url = "https://westcentralus.api.cognitive.microsoft.com/vision/v2.0/analyze?visualFeatures=Categories,Tags,Description,Faces,ImageType,Color,Adult&details=Celebrities,Landmarks&subscription-key=" + api_key
